    ...
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
        ...
        <CardContent className="space-y-4">
            ...
            <div className="space-y-1">
                ...
                <Progress value={100} className="h-2" activeColor="bg-orange-400" />
            </div>
            <div className="space-y-1">
                <div className="flex items-center gap-1">
                ...
                <Progress value={80} className="h-2" activeColor="bg-blue-400" />
            </div>
            <div className="space-y-1">
                <div className="flex items-center gap-1">
                ...
                <Progress value={90} className="h-2" activeColor="bg-green-400" />
            </div>
            <div className="space-y-1">
                <div className="flex items-center gap-1">
                ...
                <Progress value={100} className="h-2" activeColor="bg-purple-400" />
            </div>
            </div>
